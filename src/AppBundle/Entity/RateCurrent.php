 ...
 * Rate
 *
 * @ORM\Table(name="rates_current")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\RateCurrentRepository")
 */
class RateCurrent
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bank", inversedBy="rateCurrent")
