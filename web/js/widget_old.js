...
var widgetTextColor = '000000';
var widgetWidth = 215;
var widgetHeight = 135;

generateLink(widgetLanguage, widgetBackground, widgetHeight, widgetWidth);
...
function generateLink(language, color_background, size_height, size_width) {
    var html = '<iframe src="http://bankinfo.am/'+language+'/bankinfo-widget/' + color_background + '/' + size_height + '/' + size_width + '" frameborder="0" scrolling="no" allowtransparency="true" height="'+size_height+'px" width="'+size_width+'px"></iframe>';
